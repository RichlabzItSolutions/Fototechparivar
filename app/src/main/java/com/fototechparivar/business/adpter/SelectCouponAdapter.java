...
public class SelectCouponAdapter extends BaseAdapter {
    ...
    Context context;
    ArrayList<GetCouponCodeListDetails> data;
    private ArrayList<GetCouponCodeListDetails> arraylist;

    public SelectCouponAdapter(Context context, ArrayList<GetCouponCodeListDetails> list_country) {
        this.context = context;
        data = list_country;
        this.arraylist = new ArrayList<GetCouponCodeListDetails>();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.txt_CountryName.setText(data.get(position).getCode());
    ...
    public void filter(String charText) {
        ...
        if (charText.length() == 0) {
            ...
            for (GetCouponCodeListDetails wp : arraylist) {
